...
public class Player{	
	...
	//The Player class has one default constructor
	public Player(){
	...
	*/
	...
	public void printPlayer() {
		...
		//calls the printHuman method from the Human class
		this.printHuman();
		
		//print to screen playerType property
		System.out.println("Class: " + this.playerType);
		
		//print to screen level property
		System.out.println("Level: " + this.level);
		
		//print to screen experiencePoints property
		System.out.println("  Exp: " + this.experiencePoints);
		
		//print to screen skillPoints property
		System.out.println("   SP: " + this.skillPoints);
		
		//print to screen hitPoints property
		System.out.println("   HP: " + this.hitPoints);
		
		//print to screen strength property
		System.out.println("  Str: " + this.strength);
		
		//print to screen toughness property
		System.out.println("  Tuf: " + this.toughness);
		
		//print to screen intelligence property

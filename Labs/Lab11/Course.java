/*
  ...
  Continuing your last lab, create a custom class called Course with the
  following attributes
    -Name
    -Units

  Next modify your Student class to have a list of Courses instead. In your test
  program, declare 5 Student objects (fill in random values for attributes) and
  put them in a list. Be sure to iterate through the list and print out each
  Student and information on all their attributes.
